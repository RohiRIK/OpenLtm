...
describe("getEmbedding", () => {
  it("returns null when no embedding stored", async () => {
    const { getEmbedding } = await import("../../dao/embeddings.js");
    expect(getEmbedding(db, mem1Id)).toBeNull();
  });

  it("returns the blob after setEmbedding", async () => {
    const { getEmbedding, setEmbedding } = await import("../../dao/embeddings.js");
...
describe("setEmbedding", () => {
  ...
  it("stores model and dim correctly", async () => {
    const { setEmbedding } = await import("../../dao/embeddings.js");
...
describe("deleteEmbedding", () => {
  it("removes the embedding row", async () => {
    const { getEmbedding, setEmbedding, deleteEmbedding } = await import("../../dao/embeddings.js");
  ...
  it("is idempotent — deleting a non-existent row does not throw", async () => {
    const { deleteEmbedding } = await import("../../dao/embeddings.js");
...
describe("listMemoryIdsMissingEmbedding", () => {
  ...
  it("respects the limit parameter", async () => {
    const { listMemoryIdsMissingEmbedding } = await import("../../dao/embeddings.js");
